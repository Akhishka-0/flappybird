...
function preload(){
    this.load.image("background", "assets/GameObject/background-day.png");
    this.load.image("character", "assets/GameObject/samolet.png");
    this.load.image("pillar", "assets/GameObject/wtc_1.png");
    this.load.image("gameover", "assets/GameObject/gameover.png");
    this.load.image("base", "assets/GameObject/base.png");
    this.load.image("score", "assets/GameObject/score.png");
    this.load.image("retry", "assets/GameObject/retry (1).png");
    this.load.image("startGame", "assets/GameObject/message.png");
...
function create(){
    ...
    background.displayWidht = this.sys.config.width;
    ...
    character= this.physics.add.sprite(game.config.width/4,game.config.height/2,"character");
